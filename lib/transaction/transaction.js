...
Transaction.MAX_MONEY = 84000000 * 1e8; // Luxcoin has 84M coins
...
Transaction.FEE_PER_KB = 100000; // Luxcoin default fees is 0.001 LTC
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://luxcore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by luxcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a luxcore Address object. The
 * same is true for `script`, which can be a string or a luxcore Script.
 *
