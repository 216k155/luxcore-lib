# Private Key
Represents a LUX private key and is needed to be able to spend LUX and sign transactions.
...
Note: The WIF (Wallet Import Format) includes information about the network and if the associated public key is compressed or uncompressed (thus the same LUX address will be generated by using this format).
