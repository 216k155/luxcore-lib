...
var imported = luxcore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new luxcore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new luxcore.URI(paymentInfo).toString();
```
